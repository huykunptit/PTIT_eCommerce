...
@php
  ...
  $categories = collect([
      (object) ['id'=>101,'title'=>'Men\'s Fashion'],
      (object) ['id'=>102,'title'=>'Women\'s Fashion'],
      (object) ['id'=>103,'title'=>'Accessories'],
  ]);
  
  // Fake category list for small banner
  $category_lists = collect([
      (object) ['id'=>101,'title'=>'Men\'s Collection','slug'=>'mens-collection','photo'=>'https://picsum.photos/600/370?random=501','is_parent'=>1],
      (object) ['id'=>102,'title'=>'Women\'s Collection','slug'=>'womens-collection','photo'=>'https://picsum.photos/600/370?random=502','is_parent'=>1],
      (object) ['id'=>103,'title'=>'Accessories','slug'=>'accessories','photo'=>'https://picsum.photos/600/370?random=503','is_parent'=>1],
  ]);
@endphp
